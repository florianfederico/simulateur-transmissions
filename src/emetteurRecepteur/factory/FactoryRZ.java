...
import emetteurRecepteur.recepteur.impl.RecepteurRZ;
 ...
 */
public class FactoryRZ extends AFactoryEmetteurRecepteur {
	 ...
	 * 
	 * @see
	 * emetteurRecepteur.factory.AFactoryEmetteurRecepteur#creerEmetteur(int,
	 * float, float)
	 */
	@Override
	public AEmetteur creerEmetteur(int ne, float aMin, float aMax) {
		return new EmetteurRZ(ne, aMin, aMax);
	}
	 ...
	 * 
	 * @see
	 * emetteurRecepteur.recepteur.factory.AFactoryRecepteur#creerRecepteur(
	 * emetteurRecepteur.recepteur.detecteur.impl.EnumDetecteur, int, float,
	 * float)
	 */
	@Override
	public ARecepteur creerRecepteur(EnumDetecteur detecteurType, int ne, float aMin, float aMax) {
		AForm form = new RZ(ne, aMin, aMax);
		ADetecteur detecteur = this.creerDetecteur(detecteurType, form);
		return new RecepteurRZ(detecteur);
	}
	 ...
	 * @see
	 * emetteurRecepteur.recepteur.factory.AFactoryRecepteur#creerRecepteur(
	 * emetteurRecepteur.recepteur.detecteur.impl.EnumDetecteur)
	 */
	@Override
