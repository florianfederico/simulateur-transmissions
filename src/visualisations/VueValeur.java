...
public class VueValeur extends Vue {
	...
	// y0Axe += 0;
	// }
	// getContentPane().getGraphics().drawLine(x0Axe, y0Axe, x0Axe + (int)
	// deltaX + x0Axe, y0Axe);
	// getContentPane().getGraphics().drawLine(x0Axe + (int) deltaX + x0Axe - 5,
	// y0Axe - 5, x0Axe + (int) deltaX + x0Axe, y0Axe);
	// getContentPane().getGraphics().drawLine(x0Axe + (int) deltaX + x0Axe - 5,
	// y0Axe + 5, x0Axe + (int) deltaX + x0Axe, y0Axe);
	//
	// getContentPane().getGraphics().drawLine(x0Axe, y0Axe, x0Axe, y0Axe -
	// (int) deltaY - y0Axe);
	...
	// getContentPane().getGraphics().drawLine( x0Axe + x1, y0Axe - y1, x0Axe +
	// x2, y0Axe - y2);
	// }
	//
	// }
